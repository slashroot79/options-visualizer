...
A free, **interactive, beginner-friendly** web tool to understand stock options — with zero jargon. Everything runs 100% in your browser.

**Educational only — not financial advice.** 

Numbers are simplified (they ignore time value, commissions, taxes etc). 
...
2. **The clearinghouse (OCC) chain** — click through and watch the ledger that shows how a single contract changes hands (Alice → You → Carol → Dave), for **both calls and puts**, and how **covered vs naked** writers are affected at assignment.
